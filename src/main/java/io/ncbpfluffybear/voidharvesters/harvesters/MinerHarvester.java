 ...
 */
public class MinerHarvester extends Harvester implements Listener {

    public MinerHarvester(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
